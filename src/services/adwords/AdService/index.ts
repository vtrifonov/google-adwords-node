...
import { IAd, IExpandedTextAd, IImageAd, IProductAd, IResponsiveDisplayAd, IResponsiveSearchAd, PartialAd, ITemplateAd, IMultiAssetResponsiveDisplayAd, IUniversalApAd } from './Ad';
